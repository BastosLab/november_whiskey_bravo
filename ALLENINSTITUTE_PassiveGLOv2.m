function task_data = ALLENINSTITUTE_PassiveGLOv2(nwb)
...
task_data.igo_rndctl                         = task_data.seq_type == seq_igo_type & task_data.rndctl & task_data.presentation==4; % inverse 'global oddball' presentation in random control
...
task_data.ilo_rndctl                         = task_data.seq_type == seq_ilo_type & task_data.rndctl & task_data.presentation==4; % inverse 'local oddball' presentation in random control
...
task_data.igo_seqctl                         = task_data.seq_type == seq_igo_type & task_data.seqctl & task_data.presentation==4; % inverse 'global oddball' presentation in sequence control
task_data.lo_seqctl                          = task_data.seq_type == seq_lo_type & task_data.seqctl & task_data.presentation==4; % 'global oddball' presentation in sequence control
task_data.ilo_seqctl                         = task_data.seq_type == seq_ilo_type & task_data.seqctl & task_data.presentation==4; % inverse 'global oddball' presentation in sequence control
